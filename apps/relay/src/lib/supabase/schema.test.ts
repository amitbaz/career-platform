...
const migrationPath = supabaseMigration("202608290001_adaptive_interview_foundation.sql");
const competencyMigrationPath = supabaseMigration("202608290009_competency_names.sql");
