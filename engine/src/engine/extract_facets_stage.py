...
from engine.facets import FacetExtractionError, PostingFacts, extract_facets
from engine.models import JobFacets
...
def drain_extract_facets(
    ...
    *,
    ...
    Its own process on its own schedule (`python -m engine
