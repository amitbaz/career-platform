...
from engine.content_confidence import AGGREGATOR_TEXT, OFFICIAL_ATS
from engine.job_identity import normalize_company_name
from engine.models import Evaluation, Job, Material
from engine.search_profile import SearchProfile, SearchProfileMarket
from engine.store_mapping import from_iso
...
def test_get_evaluation_and_material_roundtrip(store):
    ...
    # other test shares -- see the note in engine/AGENTS.md.
    job = Job(
    ...
    from engine.models import Material
...
def test_set_job_statuses_keeps_every_url_filter_under_the_proxy_limit(
    ...
    """
    from engine import postgres_store as module
...
def test_evaluations_with_identical_evaluated_at_converge_on_one_deterministic_row(
    ...
    """
    import engine.postgres_store as postgres_store_module
