...
import engine.canonical as canonical
from engine.availability import CLOSED, UNCHECKED, UNVERIFIED, VERIFIED
...
def test_fetch_authoritative_description_dispatches_by_provider(monkeypatch):
    ...
    monkeypatch.setattr("engine.sources.ashby.fetch_description", fake_fetch)
...
def test_fetch_authoritative_description_swallows_fetch_errors(monkeypatch):
    ...
    monkeypatch.setattr("engine.sources.ashby.fetch_description", raising_fetch)
