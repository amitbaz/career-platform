...
from engine.hard_blockers import BlockingThresholds, hard_blockers_from_facets
from engine.matching import match_jobs
...
from engine.ranking import profile_priority_score
...
def test_match_jobs_stops_and_returns_what_it_has_on_quota_exhaustion(
    ...
    from engine.ai import AIBudgetExceeded
